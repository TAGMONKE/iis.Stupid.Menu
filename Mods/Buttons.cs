    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Room Mods [6]
                ...
                //added more auto-join codes (creds to iidk for original. more added by leah.)
                ...
                //new ButtonInfo { buttonText = "Auto Join Room \"goldentrophy\"", method =() => Important.AutoJoinRoomgoldentrophy(), isTogglable = false, toolTip = "Automatically attempts to connect to room \"goldentrophy\" every couple of seconds until connected." },
            },
